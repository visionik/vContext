...
vAgenda supports multiple agents (AI or human) working on plans and todo lists in parallel through forking, conflict detection, and merge operations.
...
vAgenda supports evolving playbooks where plans and todo lists accumulate, refine, and organize strategies through execution feedback.
...
```json
{
  "archival": {
    ...
    "softwareUsed": [
      {"name": "vAgenda Client", "version": "1.0.0"},
...
4. **Schemas**: Bundle the vAgenda specification version used
...
├── vagenda-spec-v1.0.md         # Specification version used
...
vAgenda draws inspiration from iCalendar (RFC 5545) and vCard (RFC 6350) standards:
...
- vAgenda uses JSON/TRON instead of plain text format
